...
data_arg.add_argument('--datadir', type=str, default='/home/gihunkim/Data')
data_arg.add_argument('--dataname', type=str, default="SpraseView_fan")


# Network
network_arg = add_argument_group('Network')
network_arg.add_argument('--model', type=str, default="unet", choices=["UNET", 'VGG'])
network_arg.add_argument('--losses', type=tuple, default=tuple(["MSE", "sinoloss_MSE"]), )
...
proj_arg.add_argument('--cpu', action='store_false',
